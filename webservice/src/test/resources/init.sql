...
insert into user values(3, 'Jack', 'Handy', 'jh1942@lion.lmu.edu', 'DeepThoughts');
insert into user values(4, 'Heather', 'Northington', 'h.north@lion.lmu.edu', 'hnorth');
insert into user values(5, 'Ignatius', 'Krumpkin', 'iggy@hotmail.com', 'IKOK');
